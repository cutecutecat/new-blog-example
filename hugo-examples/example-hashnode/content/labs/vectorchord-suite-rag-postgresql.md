---
title: "Build Production RAG in PostgreSQL with the VectorChord Suite"
description: "Use VectorChord, VectorChord-BM25, and pg_tokenizer to build scalable hybrid and multimodal RAG directly inside PostgreSQL."
author: "vectorchord"
date: 2026-04-27
heroImage: /images/covers/vectorchord-suite-rag-postgresql.svg
---
...
You can use the `tensorchord/vchord-suite` image to run multiple extensions provided by TensorChord. The image is based on the official Postgres image and includes the following extensions:
...
# If you want to use a specific version, you can use the tag `pg17-20250414`. Supported versions can be found in the support matrix.
```
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1744643437495/b57592c9-e1c2-4940-ae59-751ff93e37a3.jpeg)
...
### Use Case 2: Beyond Text - OCR-Free RAG with ColQwen2 and VectorChord
...
- **Lossy:** Crucial visual context such as tables, figures, formatting, and relative positioning is often lost during text extraction.
...
2. **VectorChord's Multi-Vector Capabilities:** VectorChord can efficiently store and search *multiple* vectors per document within Postgres, allowing you to store embeddings representing different aspects (for example, text content and visual layout).
...
In our previous blog posts, we shared user cases where all images can be replaced with the VectorChord Suite image.
...
- [Beyond Text: Unlock OCR-Free RAG in PostgreSQL with Modal and VectorChord](https://blog.vectorchord.ai/preview/67e35c2ffba3e0edbac95265)
